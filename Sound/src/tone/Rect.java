...
public class Rect extends Tone implements ChangeListener,ActionListener
{
	int frequency;
	...
	{
		return Math.signum(Math.sin(Math.PI*this.frequency*time));
	}
	...
	private void createOptionPanel()
	{
		...
		this.sliderfrequency= new JSlider(JSlider.HORIZONTAL,1, 15000, 1);
